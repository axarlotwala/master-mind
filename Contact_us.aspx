<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Contact_us.aspx.cs" Inherits="Contact_us" %>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="block-bread">
          ...
          <span><i class="fa fa-angle-right" aria-hidden="true"></i>Feedback</span>
        </div>
      </div>
    </div>
    </div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sidebar">
					...
					<!-- Block Bar Categories End -->

					<!-- Block Bar Bunner Start -->
							<!-- Block Bar Bunner End -->
				...
				<div class="box-contacts">
					...
					<div class="top">
						<div action="http://ecom.webark.io/" class="form-contact">


                        <asp:TextBox ID="txtname" class="name" name="contact-name" placeholder="NAME" runat="server"></asp:TextBox>
						<asp:TextBox ID="txtmail" class="email" name="contact-email"  placeholder="E-mail" runat="server"></asp:TextBox>
						<asp:TextBox ID="txtmsg" class="message" cols="30" rows="10" placeholder="MESSAGE" TextMode="MultiLine" runat="server"></asp:TextBox>
                          <asp:Button ID="btnsubmit"  class="btn-contact button-lardge" runat="server" Text="Add Feedback" OnClick="btnsubmit_Click"/>  

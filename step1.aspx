<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="step1.aspx.cs" Inherits="step1" %>
		...
		<div class="container-fluid">
			<div class="row" style="margin-left:400px;">
				...
				<div class="box-contacts">
                  ...
                  <asp:TextBox ID="txtContact" Class="name" name="contact-name" placeholder="Contact No"  runat="server"></asp:TextBox> 
                 
          		    <asp:Button ID="btnsubmit" class="btn-contact button-lardge"  runat="server" Text="SUBMIT" OnClick="btnsubmit_Click" />

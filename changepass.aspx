		...
		<div class="container-fluid">
			<div class="row" style="margin-left:400px;">
                ...
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  ...
                  <asp:TextBox ID="txtcurrentpassword" Class="name" name="contact-name" placeholder="Current Password"  runat="server"></asp:TextBox> 
          		   <asp:TextBox ID="txtnewpassword1" Class="name" name="contact-name" placeholder="New Password"  runat="server"></asp:TextBox> 
                   <asp:TextBox ID="txtconfirmpassword1" Class="name" name="contact-name" placeholder="Confirm Password"  runat="server"></asp:TextBox> 

<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="product_list.aspx.cs" Inherits="product_list" %>
           ...
           <ItemTemplate>
										...
										<tr>
											<td class="cart-thumbnail">
												<div class="cart-img"><a href="#"><img src="admin/image/product/<%# Eval("img") %>" alt=""></a></div>
											</td>
											<td class="cart-name-prodct" style="width:40%" data-title="Product">
												<a href="#"><span><%# Eval("pname") %></span></a>
											</td>
											<td class="cart-mark" data-mark="Mark">
												<span><%# Eval("cname") %></span>
											</td>
											<td class="alone-price" data-price="Price">
												<span> Rs.<%# Eval("price") %> </span>
											</td>
											<td>
											<a href="Ticket.aspx?pid=<%# Eval("product_id") %>" class="button-small">Add Complain </a>

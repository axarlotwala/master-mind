<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="step2.aspx.cs" Inherits="step2" %>
		...
		<div class="container-fluid">
			<div class="row" style="margin-left:400px;">
				...
				<div class="box-contacts">
                  ...
                  <asp:TextBox ID="txtotp" Class="name" name="contact-name" placeholder="Enter OTP Code"  runat="server"></asp:TextBox> 
                 
          		    <asp:Button ID="btnsubmit" OnClick="btnsubmit_Click" class="btn-contact button-lardge"  runat="server" Text="SUBMIT" /> 
				</div>

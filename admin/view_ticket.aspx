<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="view_ticket.aspx.cs" Inherits="admin_view_ticket" %>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <%--  <td><img src="../Upload/Ticket/<%# Eval("problem_image") %>" style="height:50px; width:50px;" /></td--%>>
                            ...
                            <td><%# Eval("status") %></td>
                                  <td> <a class="btn btn-icon waves-effect waves-light btn-danger m-b-5" data-id="<%# Eval("ticket_id") %>" data-toggle="modal" data-target=".bs-example-modal-sm"><i class="fa fa-trash-o"></i></a> </td>                
                        </tr>
                  </ItemTemplate>
                               </asp:Repeater>
                      </tbody>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".btn-danger").click(function () {
                ...
                document.getElementById("<% =hfcid.ClientID %>").value = tid;
        });
    });

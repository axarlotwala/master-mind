<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="view_cart.aspx.cs" Inherits="admin_view_cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h4 class="pull-left page-title">Add To Cart</h4>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><%#"ptitle" %></td>
                            <td><%# "qty" %></td>
                          <td><%# "cart_added_date" %></td>
                          <td>
<a class="btn btn-icon waves-effect waves-light btn-success m-b-5" ><i class="fa fa-edit"></i></a>
<a href="?del=<%#Eval("cart_id") %>" class="btn btn-icon waves-effect waves-light btn-danger m-b-5" onclick="return confirm('Are You Sure Want To Delete ??')"><i class="fa fa-trash-o"></i></a>
                          </td>
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body"><h4>Are you sure want to  delete ?</h4>
                                                    <br />
                                                    <asp:HiddenField ID="hfcrt_id" runat="server" />
          ...
          <script>
              $(document).ready(function () {
                  ...
                  $(".btn-danger").click(function () {
                      ...
                      var crt_id = $(this).data('id');
                      // alert(cart_id);

                      document.getElementById("<% =hfcrt_id.ClientID %>").value = cart_id;
        });
              });
